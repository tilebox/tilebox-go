...
const file_workflows_v1_task_proto_rawDesc = "" +
	...
	"\tsub_tasks\x18\x03 \x03(\v2\x1c.workflows.v1.TaskSubmissionB\b\xbaH\x05\x92\x01\x02\x10@R\bsubTasks\"g\n" +
...
var file_workflows_v1_task_proto_goTypes = []any{
	...
	(*Task)(nil),                // 12: workflows.v1.Task
	(TaskState)(0),              // 13: workflows.v1.TaskState
...
var file_workflows_v1_task_proto_depIdxs = []int32{
	...
	11, // 5: workflows.v1.IdlingResponse.suggested_idling_duration:type_name -> google.protobuf.Duration
	12, // 6: workflows.v1.NextTaskResponse.next_task:type_name -> workflows.v1.Task
	3,  // 7: workflows.v1.NextTaskResponse.idling:type_name -> workflows.v1.IdlingResponse
	9,  // 8: workflows.v1.TaskFailedRequest.task_id:type_name -> tilebox.v1.ID
	13, // 9: workflows.v1.TaskStateResponse.state:type_name -> workflows.v1.TaskState
	9,  // 10: workflows.v1.TaskLeaseRequest.task_id:type_name -> tilebox.v1.ID
	11, // 11: workflows.v1.TaskLeaseRequest.requested_lease:type_name -> google.protobuf.Duration
	0,  // 12: workflows.v1.TaskService.NextTask:input_type -> workflows.v1.NextTaskRequest
	5,  // 13: workflows.v1.TaskService.TaskFailed:input_type -> workflows.v1.TaskFailedRequest
	7,  // 14: workflows.v1.TaskService.ExtendTaskLease:input_type -> workflows.v1.TaskLeaseRequest
	4,  // 15: workflows.v1.TaskService.NextTask:output_type -> workflows.v1.NextTaskResponse
	6,  // 16: workflows.v1.TaskService.TaskFailed:output_type -> workflows.v1.TaskStateResponse
	14, // 17: workflows.v1.TaskService.ExtendTaskLease:output_type -> workflows.v1.TaskLease
