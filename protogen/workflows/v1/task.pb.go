...
type ComputedTask struct {
	...
	xxx_hidden_SubTasks        *TaskSubmissions         `protobuf:"bytes,5,opt,name=sub_tasks,json=subTasks"`
	xxx_hidden_ProgressUpdates *[]*Progress             `protobuf:"bytes,4,rep,name=progress_updates,json=progressUpdates"`
	xxx_hidden_LegacySubTasks  *[]*SingleTaskSubmission `protobuf:"bytes,3,rep,name=legacy_sub_tasks,json=legacySubTasks"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *ComputedTask) GetSubTasks() *TaskSubmissions {
	if x != nil {
...
// Deprecated: Marked as deprecated in workflows/v1/task.proto.
func (x *ComputedTask) GetLegacySubTasks() []*SingleTaskSubmission {
	if x != nil {
		if x.xxx_hidden_LegacySubTasks != nil {
			return *x.xxx_hidden_LegacySubTasks
		}
	}
	return nil
}
...
func (x *ComputedTask) SetSubTasks(v *TaskSubmissions) {
...
// Deprecated: Marked as deprecated in workflows/v1/task.proto.
func (x *ComputedTask) SetLegacySubTasks(v []*SingleTaskSubmission) {
	x.xxx_hidden_LegacySubTasks = &v
}
...
func (x *ComputedTask) HasSubTasks() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_SubTasks != nil
}
...
func (x *ComputedTask) ClearSubTasks() {
	x.xxx_hidden_SubTasks = nil
}
...
type ComputedTask_builder struct {
	...
	//
	// Deprecated: Marked as deprecated in workflows/v1/task.proto.
	LegacySubTasks []*SingleTaskSubmission
}
...
func (b0 ComputedTask_builder) Build() *ComputedTask {
	...
	x.xxx_hidden_LegacySubTasks = &b.LegacySubTasks
	return m0
}
...
const file_workflows_v1_task_proto_rawDesc = "" +
	...
	"\videntifiers\x18\x02 \x03(\v2\x1c.workflows.v1.TaskIdentifierR\videntifiers\"\xaa\x02\n" +
	"\fComputedTask\x12&\n" +
	"\x02id\x18\x01 \x01(\v2\x0e.tilebox.v1.IDB\x06\xbaH\x03\xc8\x01\x01R\x02id\x12\x18\n" +
	"\adisplay\x18\x02 \x01(\tR\adisplay\x12:\n" +
	"\tsub_tasks\x18\x05 \x01(\v2\x1d.workflows.v1.TaskSubmissionsR\bsubTasks\x12A\n" +
	"\x10progress_updates\x18\x04 \x03(\v2\x16.workflows.v1.ProgressR\x0fprogressUpdates\x12Y\n" +
	"\x10legacy_sub_tasks\x18\x03 \x03(\v2\".workflows.v1.SingleTaskSubmissionB\v\xbaH\x06\x92\x01\x03\x10\xe8\a\x18\x01R\x0elegacySubTasks\"g\n" +
...
var file_workflows_v1_task_proto_goTypes = []any{
	...
	(*TaskSubmissions)(nil),      // 10: workflows.v1.TaskSubmissions
	(*Progress)(nil),             // 11: workflows.v1.Progress
	(*SingleTaskSubmission)(nil), // 12: workflows.v1.SingleTaskSubmission
	(*durationpb.Duration)(nil),  // 13: google.protobuf.Duration
	(*Task)(nil),                 // 14: workflows.v1.Task
	(TaskState)(0),               // 15: workflows.v1.TaskState
	(*TaskLease)(nil),            // 16: workflows.v1.TaskLease
}
var file_workflows_v1_task_proto_depIdxs = []int32{
	...
	10, // 4: workflows.v1.ComputedTask.sub_tasks:type_name -> workflows.v1.TaskSubmissions
	11, // 5: workflows.v1.ComputedTask.progress_updates:type_name -> workflows.v1.Progress
	12, // 6: workflows.v1.ComputedTask.legacy_sub_tasks:type_name -> workflows.v1.SingleTaskSubmission
	13, // 7: workflows.v1.IdlingResponse.suggested_idling_duration:type_name -> google.protobuf.Duration
	14, // 8: workflows.v1.NextTaskResponse.next_task:type_name -> workflows.v1.Task
	3,  // 9: workflows.v1.NextTaskResponse.idling:type_name -> workflows.v1.IdlingResponse
	9,  // 10: workflows.v1.TaskFailedRequest.task_id:type_name -> tilebox.v1.ID
	11, // 11: workflows.v1.TaskFailedRequest.progress_updates:type_name -> workflows.v1.Progress
	15, // 12: workflows.v1.TaskStateResponse.state:type_name -> workflows.v1.TaskState
	9,  // 13: workflows.v1.TaskLeaseRequest.task_id:type_name -> tilebox.v1.ID
	13, // 14: workflows.v1.TaskLeaseRequest.requested_lease:type_name -> google.protobuf.Duration
	0,  // 15: workflows.v1.TaskService.NextTask:input_type -> workflows.v1.NextTaskRequest
	5,  // 16: workflows.v1.TaskService.TaskFailed:input_type -> workflows.v1.TaskFailedRequest
	7,  // 17: workflows.v1.TaskService.ExtendTaskLease:input_type -> workflows.v1.TaskLeaseRequest
	4,  // 18: workflows.v1.TaskService.NextTask:output_type -> workflows.v1.NextTaskResponse
	6,  // 19: workflows.v1.TaskService.TaskFailed:output_type -> workflows.v1.TaskStateResponse
	16, // 20: workflows.v1.TaskService.ExtendTaskLease:output_type -> workflows.v1.TaskLease
