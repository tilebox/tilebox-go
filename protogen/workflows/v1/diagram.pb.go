...
const file_workflows_v1_diagram_proto_rawDesc = "" +
	...
	"\x0erender_options\x18\x02 \x01(\v2\x1b.workflows.v1.RenderOptionsR\rrenderOptions\"\xd0\x01\n" +
	"\rRenderOptions\x12+\n" +
	"\x06layout\x18\x01 \x01(\tB\x13\xbaH\x10r\x0eR\x00R\x05dagreR\x03elkR\x06layout\x12 \n" +
	...
	"\tdirection\x18\x05 \x01(\tB\x1e\xbaH\x1br\x19R\x00R\x02upR\x04downR\x05rightR\x04leftR\tdirection\"\x1b\n" +
	"\aDiagram\x12\x10\n" +
