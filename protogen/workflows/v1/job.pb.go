...
var file_workflows_v1_job_proto_goTypes = []any{
	...
	(*TaskSubmission)(nil),          // 15: workflows.v1.TaskSubmission
	(*v1.ID)(nil),                   // 16: tilebox.v1.ID
	(*RenderOptions)(nil),           // 17: workflows.v1.RenderOptions
	(*v1.TimeInterval)(nil),         // 18: tilebox.v1.TimeInterval
	(*v1.IDInterval)(nil),           // 19: tilebox.v1.IDInterval
	(*v1.Pagination)(nil),           // 20: tilebox.v1.Pagination
	(*Job)(nil),                     // 21: workflows.v1.Job
	(*Diagram)(nil),                 // 22: workflows.v1.Diagram
}
var file_workflows_v1_job_proto_depIdxs = []int32{
	15, // 0: workflows.v1.SubmitJobRequest.tasks:type_name -> workflows.v1.TaskSubmission
	16, // 1: workflows.v1.SubmitJobRequest.automation_id:type_name -> tilebox.v1.ID
	16, // 2: workflows.v1.GetJobRequest.job_id:type_name -> tilebox.v1.ID
	16, // 3: workflows.v1.GetJobProgressRequest.job_id:type_name -> tilebox.v1.ID
	16, // 4: workflows.v1.RetryJobRequest.job_id:type_name -> tilebox.v1.ID
	16, // 5: workflows.v1.CancelJobRequest.job_id:type_name -> tilebox.v1.ID
	16, // 6: workflows.v1.VisualizeJobRequest.job_id:type_name -> tilebox.v1.ID
	17, // 7: workflows.v1.VisualizeJobRequest.render_options:type_name -> workflows.v1.RenderOptions
	0,  // 8: workflows.v1.VisualizeJobRequest.theme:type_name -> workflows.v1.WorkflowDiagramTheme
	18, // 9: workflows.v1.QueryFilters.time_interval:type_name -> tilebox.v1.TimeInterval
	19, // 10: workflows.v1.QueryFilters.id_interval:type_name -> tilebox.v1.IDInterval
	16, // 11: workflows.v1.QueryFilters.automation_id:type_name -> tilebox.v1.ID
	9,  // 12: workflows.v1.QueryJobsRequest.filters:type_name -> workflows.v1.QueryFilters
	20, // 13: workflows.v1.QueryJobsRequest.page:type_name -> tilebox.v1.Pagination
	21, // 14: workflows.v1.QueryJobsResponse.jobs:type_name -> workflows.v1.Job
	20, // 15: workflows.v1.QueryJobsResponse.next_page:type_name -> tilebox.v1.Pagination
	16, // 16: workflows.v1.GetJobPrototypeRequest.job_id:type_name -> tilebox.v1.ID
	15, // 17: workflows.v1.GetJobPrototypeResponse.root_tasks:type_name -> workflows.v1.TaskSubmission
	16, // 18: workflows.v1.CloneJobRequest.job_id:type_name -> tilebox.v1.ID
	15, // 19: workflows.v1.CloneJobRequest.root_tasks_overrides:type_name -> workflows.v1.TaskSubmission
	1,  // 20: workflows.v1.JobService.SubmitJob:input_type -> workflows.v1.SubmitJobRequest
	2,  // 21: workflows.v1.JobService.GetJob:input_type -> workflows.v1.GetJobRequest
	3,  // 22: workflows.v1.JobService.GetJobProgress:input_type -> workflows.v1.GetJobProgressRequest
	4,  // 23: workflows.v1.JobService.RetryJob:input_type -> workflows.v1.RetryJobRequest
	6,  // 24: workflows.v1.JobService.CancelJob:input_type -> workflows.v1.CancelJobRequest
	8,  // 25: workflows.v1.JobService.VisualizeJob:input_type -> workflows.v1.VisualizeJobRequest
	10, // 26: workflows.v1.JobService.QueryJobs:input_type -> workflows.v1.QueryJobsRequest
	12, // 27: workflows.v1.JobService.GetJobPrototype:input_type -> workflows.v1.GetJobPrototypeRequest
	14, // 28: workflows.v1.JobService.CloneJob:input_type -> workflows.v1.CloneJobRequest
	21, // 29: workflows.v1.JobService.SubmitJob:output_type -> workflows.v1.Job
	21, // 30: workflows.v1.JobService.GetJob:output_type -> workflows.v1.Job
	21, // 31: workflows.v1.JobService.GetJobProgress:output_type -> workflows.v1.Job
	5,  // 32: workflows.v1.JobService.RetryJob:output_type -> workflows.v1.RetryJobResponse
	7,  // 33: workflows.v1.JobService.CancelJob:output_type -> workflows.v1.CancelJobResponse
	22, // 34: workflows.v1.JobService.VisualizeJob:output_type -> workflows.v1.Diagram
	11, // 35: workflows.v1.JobService.QueryJobs:output_type -> workflows.v1.QueryJobsResponse
	13, // 36: workflows.v1.JobService.GetJobPrototype:output_type -> workflows.v1.GetJobPrototypeResponse
	21, // 37: workflows.v1.JobService.CloneJob:output_type -> workflows.v1.Job
