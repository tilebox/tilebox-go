...
const file_workflows_v1_core_proto_rawDesc = "" +
	...
	"\tdeletable\x18\x04 \x01(\bR\tdeletable\"\xd1\x03\n" +
	"\x03Job\x12\x1e\n" +
	...
	"\bprogress\x18\v \x03(\v2\x16.workflows.v1.ProgressR\bprogressJ\x04\b\x04\x10\x05\"\x9f\x02\n" +
	...
	"%recommended_wait_until_next_extension\x18\x02 \x01(\v2\x19.google.protobuf.DurationR!recommendedWaitUntilNextExtension*k\n" +
	"\bJobState\x12\x19\n" +
	...
	"\x14TASK_STATE_CANCELLED\x10\x05B\xb4\x01\n" +
...
var file_workflows_v1_core_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_workflows_v1_core_proto_goTypes = []any{
	...
	(*Progress)(nil),              // 5: workflows.v1.Progress
	(*Task)(nil),                  // 6: workflows.v1.Task
	(*TaskIdentifier)(nil),        // 7: workflows.v1.TaskIdentifier
	(*Tasks)(nil),                 // 8: workflows.v1.Tasks
...
var file_workflows_v1_core_proto_depIdxs = []int32{
	11, // 0: workflows.v1.Job.id:type_name -> tilebox.v1.ID
	...
	11, // 5: workflows.v1.Job.automation_id:type_name -> tilebox.v1.ID
	5,  // 6: workflows.v1.Job.progress:type_name -> workflows.v1.Progress
	11, // 7: workflows.v1.TaskSummary.id:type_name -> tilebox.v1.ID
	1,  // 8: workflows.v1.TaskSummary.state:type_name -> workflows.v1.TaskState
	11, // 9: workflows.v1.TaskSummary.parent_id:type_name -> tilebox.v1.ID
	12, // 10: workflows.v1.TaskSummary.started_at:type_name -> google.protobuf.Timestamp
	12, // 11: workflows.v1.TaskSummary.stopped_at:type_name -> google.protobuf.Timestamp
	11, // 12: workflows.v1.Task.id:type_name -> tilebox.v1.ID
	7,  // 13: workflows.v1.Task.identifier:type_name -> workflows.v1.TaskIdentifier
	1,  // 14: workflows.v1.Task.state:type_name -> workflows.v1.TaskState
	3,  // 15: workflows.v1.Task.job:type_name -> workflows.v1.Job
	11, // 16: workflows.v1.Task.parent_id:type_name -> tilebox.v1.ID
	11, // 17: workflows.v1.Task.depends_on:type_name -> tilebox.v1.ID
	10, // 18: workflows.v1.Task.lease:type_name -> workflows.v1.TaskLease
	6,  // 19: workflows.v1.Tasks.tasks:type_name -> workflows.v1.Task
	7,  // 20: workflows.v1.TaskSubmission.identifier:type_name -> workflows.v1.TaskIdentifier
	13, // 21: workflows.v1.TaskLease.lease:type_name -> google.protobuf.Duration
	13, // 22: workflows.v1.TaskLease.recommended_wait_until_next_extension:type_name -> google.protobuf.Duration
