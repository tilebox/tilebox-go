...
func file_workflows_v1_diagram_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_workflows_v1_diagram_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_workflows_v1_diagram_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_workflows_v1_diagram_proto_msgTypes[2].Exporter = func(v any, i int) any {
