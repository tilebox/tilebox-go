...
const file_workflows_v1_diagram_proto_rawDesc = "" +
	"\n" +
	"\x1aworkflows/v1/diagram.proto\x12\fworkflows.v1\x1a!google/protobuf/go_features.proto\"t\n" +
	...
	"\x06Render\x12\".workflows.v1.RenderDiagramRequest\x1a\x15.workflows.v1.DiagramB\xbf\x01\n" +
	"\x10com.workflows.v1B\fDiagramProtoP\x01ZBgithub.com/tilebox/tilebox-go/protogen/go/workflows/v1;workflowsv1\xa2\x02\x03WXX\xaa\x02\fWorkflows.V1\xca\x02\fWorkflows\\V1\xe2\x02\x18Workflows\\V1\\GPBMetadata\xea\x02\rWorkflows::V1\x92\x03\a\xd2>\x02\x10\x03\b\x02b\beditionsp\xe8\a"
