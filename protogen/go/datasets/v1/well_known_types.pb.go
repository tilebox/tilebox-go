...
const file_datasets_v1_well_known_types_proto_rawDesc = "" +
	...
	"\bGeometry\x12\x10\n" +
	"\x03wkb\x18\x01 \x01(\fR\x03wkb\"\xc2\v\n" +
	"\n" +
	"GeobufData\x12\x12\n" +
	...
	"\x12feature_collection\x18\x04 \x01(\v2).datasets.v1.GeobufData.FeatureCollectionH\x00R\x11featureCollection\x12;\n" +
	"\afeature\x18\x05 \x01(\v2\x1f.datasets.v1.GeobufData.FeatureH\x00R\afeature\x12>\n" +
	"\bgeometry\x18\x06 \x01(\v2 .datasets.v1.GeobufData.GeometryH\x00R\bgeometry\x1a\x81\x02\n" +
	"\aFeature\x12<\n" +
	"\bgeometry\x18\x01 \x01(\v2 .datasets.v1.GeobufData.GeometryR\bgeometry\x12\x10\n" +
	"\x02id\x18\v \x01(\tH\x00R\x02id\x12\x17\n" +
	"\x06int_id\x18\f \x01(\x12H\x00R\x05intId\x125\n" +
	"\x06values\x18\r \x03(\v2\x1d.datasets.v1.GeobufData.ValueR\x06values\x12\x1e\n" +
	"\n" +
	"properties\x18\x0e \x03(\rR\n" +
	"properties\x12+\n" +
	"\x11custom_properties\x18\x0f \x03(\rR\x10customPropertiesB\t\n" +
	"\aid_type\x1a\xd0\x03\n" +
	"\bGeometry\x129\n" +
	"\x04type\x18\x01 \x01(\x0e2%.datasets.v1.GeobufData.Geometry.TypeR\x04type\x12\x18\n" +
	"\alengths\x18\x02 \x03(\rR\alengths\x12\x16\n" +
	"\x06coords\x18\x03 \x03(\x12R\x06coords\x12@\n" +
	"\n" +
	"geometries\x18\x04 \x03(\v2 .datasets.v1.GeobufData.GeometryR\n" +
	"geometries\x125\n" +
	"\x06values\x18\r \x03(\v2\x1d.datasets.v1.GeobufData.ValueR\x06values\x12+\n" +
	"\x11custom_properties\x18\x0f \x03(\rR\x10customProperties\"\xb0\x01\n" +
	"\x04Type\x12\x0e\n" +
	"\n" +
	...
	"\fTYPE_POLYGON\x10\x05\x12\x15\n" +
	"\x11TYPE_MULTIPOLYGON\x10\x06\x12\x1b\n" +
	"\x17TYPE_GEOMETRYCOLLECTION\x10\a\x1a\xb4\x01\n" +
	"\x11FeatureCollection\x12;\n" +
	"\bfeatures\x18\x01 \x03(\v2\x1f.datasets.v1.GeobufData.FeatureR\bfeatures\x125\n" +
	"\x06values\x18\r \x03(\v2\x1d.datasets.v1.GeobufData.ValueR\x06values\x12+\n" +
	"\x11custom_properties\x18\x0f \x03(\rR\x10customProperties\x1a\xed\x01\n" +
	"\x05Value\x12#\n" +
	"\fstring_value\x18\x01 \x01(\tH\x00R\vstringValue\x12#\n" +
	"\fdouble_value\x18\x02 \x01(\x01H\x00R\vdoubleValue\x12$\n" +
	"\rpos_int_value\x18\x03 \x01(\x04H\x00R\vposIntValue\x12$\n" +
	"\rneg_int_value\x18\x04 \x01(\x04H\x00R\vnegIntValue\x12\x1f\n" +
	"\n" +
	"bool_value\x18\x05 \x01(\bH\x00R\tboolValue\x12\x1f\n" +
	"\n" +
	"json_value\x18\x06 \x01(\fH\x00R\tjsonValueB\f\n" +
	"\n" +
	"value_typeB\v\n" +
	"\tdata_type*t\n" +
