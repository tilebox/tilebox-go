...
var file_datasets_v1_opendata_proto_rawDesc = []byte{
...
var (
	...
	file_datasets_v1_opendata_proto_rawDescData = file_datasets_v1_opendata_proto_rawDesc
)

func file_datasets_v1_opendata_proto_rawDescGZIP() []byte {
	file_datasets_v1_opendata_proto_rawDescOnce.Do(func() {
		file_datasets_v1_opendata_proto_rawDescData = protoimpl.X.CompressGZIP(file_datasets_v1_opendata_proto_rawDescData)
	})
...
func file_datasets_v1_opendata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_datasets_v1_opendata_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*ASFSarGranule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_datasets_v1_opendata_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*UmbraSarGranule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_datasets_v1_opendata_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*CopernicusDataspaceGranule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_datasets_v1_opendata_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_datasets_v1_opendata_proto_rawDesc = nil
