...
const (
	AccountService_GetAccountDetails_FullMethodName = "/accounts.v1alpha1.AccountService/GetAccountDetails"
)
...
type AccountServiceClient interface {
	...
	GetAccountDetails(ctx context.Context, in *GetAccountDetailsRequest, opts ...grpc.CallOption) (*AccountDetails, error)
}
...
func (c *accountServiceClient) GetAccountDetails(ctx context.Context, in *GetAccountDetailsRequest, opts ...grpc.CallOption) (*AccountDetails, error) {
...
type AccountServiceServer interface {
	// GetAccountDetails resolves the calling credential to its effective account details.
	// Requests without valid authentication fail with UNAUTHENTICATED.
	GetAccountDetails(context.Context, *GetAccountDetailsRequest) (*AccountDetails, error)
...
func (UnimplementedAccountServiceServer) GetAccountDetails(context.Context, *GetAccountDetailsRequest) (*AccountDetails, error) {
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "accounts/v1alpha1/account.proto",
}
